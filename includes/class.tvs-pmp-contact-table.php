...
/*		return array(
	...
	public function column_description( $item ) {
		...
		<br/>
		<p><span class="contact-mappings" data-contact-id="<?php echo intval( $item->id ); ?>"><a href="#">Contact Mappings</a></span></p>
		</div>
		<span class="contact-mapping-list" data-contact-id="<?php echo intval( $item->id ); ?>"></span>
		<?php
	}
